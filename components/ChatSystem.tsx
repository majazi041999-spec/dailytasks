    ...
    return (
        <>
            ...
            <div className="flex h-[calc(100vh-8rem)] gap-6 animate-fade-scale">
                {/* Contact List Side */}
                <div className="w-full md:w-1/3 bg-white/60 dark:bg-gray-800/60 backdrop-blur-2xl rounded-[2.5rem] border border-white/50 dark:border-gray-700/50 shadow-xl overflow-hidden flex flex-col relative transition-all duration-500 hover:shadow-2xl">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-2 custom-scrollbar">
                        {availableUsers.map(u => (
                            <div
                                ...
                                className={`flex items-center gap-4 p-4 rounded-[1.5rem] cursor-pointer transition-all duration-300 group ${selectedUser?.id === u.id ? 'bg-white dark:bg-gray-700 shadow-lg shadow-blue-900/5 scale-[1.02] border border-blue-100 dark:border-blue-900/30' : 'hover:bg-white/40 dark:hover:bg-gray-700/40 hover:scale-[1.02] border border-transparent'}`}
                            >
                ...
                {/* Chat Area */}
                <div className="hidden md:flex flex-1 bg-white/40 dark:bg-gray-800/40 backdrop-blur-3xl rounded-[2.5rem] border border-white/50 dark:border-gray-700/50 shadow-xl overflow-hidden flex-col relative transition-all duration-500">
                    {/* Background Pattern */}
                    ...
                    {selectedUser ? (
                        <>
                            <div className="p-5 bg-white/70 dark:bg-gray-900/70 backdrop-blur-md border-b border-white/40 dark:border-white/5 flex items-center justify-between z-10 shadow-sm animate-in fade-in slide-in-from-top-4 duration-500">
                                ...
                                <button
                                    ...
                                    className="bg-red-50 dark:bg-red-900/20 text-red-500 p-3 rounded-xl hover:bg-red-500 hover:text-white transition-all shadow-sm flex items-center gap-2 text-xs font-bold hover:scale-105 active:scale-95"
                                    title="حذف کل گفتگو"
                                >
                                    <Trash size={18} />
                                    حذف گفتگو
                            ...
                            <div className="p-4 bg-white/70 dark:bg-gray-900/70 backdrop-blur-md border-t border-white/30 dark:border-white/10 z-10 flex flex-col gap-2 animate-in slide-in-from-bottom-2 duration-500">
                                ...
                                <form onSubmit={handleSend} className="flex gap-3 items-end">
                                    ...
                                    <button type="submit" disabled={!newMessage.trim() && !attachment} className="bg-gradient-to-tr from-blue-600 to-indigo-600 hover:shadow-lg hover:shadow-blue-500/40 text-white p-4 rounded-full transition-all transform hover:scale-110 active:scale-90 mb-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none">
